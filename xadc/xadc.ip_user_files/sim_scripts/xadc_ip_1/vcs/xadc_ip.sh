...
#                script (type 'xadc_ip.sh -help' for more information).
#
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.xadc_ip xil_defaultlib.glbl -o xadc_ip_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./xadc_ip_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/luka/FPGA/digitalnoNacrt/xadc/xadc.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key xadc_ip_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc xadc_ip_simv.daidir vcs_lib c.obj)
