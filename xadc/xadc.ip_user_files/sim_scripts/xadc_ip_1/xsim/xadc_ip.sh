...
#
# Script generated by Vivado on Tue May 13 22:07:58 AWST 2025
...
#
# Usage        : xadc_ip.sh
#                xadc_ip.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                xadc_ip.sh [-reset_run]
#                xadc_ip.sh [-reset_log]
#                xadc_ip.sh [-help]
#
...
export RDI_DATADIR="/home/luka/vivado/Vivado/2024.2/data"

# set xvlog options
xvlog_opts="--incr --relax "

# script info
echo -e "xadc_ip.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./xadc_ip.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot xadc_ip xil_defaultlib.xadc_ip xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim xadc_ip -key {Behavioral:sim_1:Functional:xadc_ip} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_fc5c_0.protoinst" -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/luka/vivado/Vivado/2024.2/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb xadc_ip.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./xadc_ip.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: xadc_ip.sh [-help]\n\
Usage: xadc_ip.sh [-step]\n\
Usage: xadc_ip.sh [-lib_map_path]\n\
Usage: xadc_ip.sh [-reset_run]\n\
Usage: xadc_ip.sh [-reset_log]\n\
Usage: xadc_ip.sh [-keep_index]\n\
Usage: xadc_ip.sh [-noclean_files]\n\n\
