...
HD_PWD='E:/FAX/digitalnoNacrt/vaje5/vaje5.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log string_transmitter.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source string_transmitter.tcl -notrace
