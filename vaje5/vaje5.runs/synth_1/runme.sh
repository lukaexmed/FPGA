...
HD_PWD='E:/FAX/digitalnoNacrt/vaje5/vaje5.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log string_transmitter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source string_transmitter.tcl
