...
HD_PWD='H:/digitalno/vaje3/vaje3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log rgb_controller.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source rgb_controller.tcl -notrace
