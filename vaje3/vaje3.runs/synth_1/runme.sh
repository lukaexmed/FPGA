...
HD_PWD='H:/digitalno/vaje3/vaje3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rgb_controller.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rgb_controller.tcl
